    ...
    <div class="swiper mySwiper h-full">
      <div class="swiper-wrapper">
        ...
        <div class="swiper-slide relative">
          <img src="\Clothing-Web-Application-Development\images\women\bagmain.png" alt="Moon Child 2" class="w-full h-full object-cover" />
        ...
        <!-- Slide 2 -->
        <div class="swiper-slide relative">
          <img src="\Clothing-Web-Application-Development\images\women\women.png" alt="Moon Child 2" class="w-full h-full object-cover" />
          <div class="absolute inset-0 bg-black bg-opacity-40 flex flex-col items-center justify-center text-white text-center px-4">
            <h2 class="text-4xl font-bold mb-2">Mandela</h2>
        ...
        <!-- Slide 3 -->
        <div class="swiper-slide relative">
          <img src="\Clothing-Web-Application-Development\images\women\home-decor.png" alt="Moon Child 3" class="w-full h-full object-cover" />
          <div class="absolute inset-0 bg-black bg-opacity-40 flex flex-col items-center justify-center text-white text-center px-4">
            <h2 class="text-4xl font-bold mb-2">Mandela</h2>
...
<div class="banner">
  ...
  <img src="\Clothing-Web-Application-Development\images\women\under banner.jpg" alt="Model" class="model-image" />
</div>
